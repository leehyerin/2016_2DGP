...
class Skill_WideDamage_W:
    ...
    def draw(self):
        self.image.clip_draw(self.frame * 50, 0, 50, 99, self.x, self.y,100,200)
...
class Skill_Flame_F:
    ...
    def __init__(self, Pokemon):
        ...
        self.x, self.y = Pokemon.x, Pokemon.y
        self.frame = 0
        if Skill_Flame_F.image == None:
            self.image = load_image('resource/skill/flame.png')
    ...
    def create_left(self):
        self.x -= 7 * self.distance

    def create_right(self):
        self.x += 7 * self.distance

    def create_up(self):
        self.y += 7 * self.distance
    ...
    def draw(self):
        self.image.clip_draw(self.frame * 34, 0, 34, 49, self.x, self.y)
...
class Skill_Stem_Chain:
    ...
    def __init__(self, Pokemon: object) -> object:
        ...
        self.frame = 0
        if Skill_WideDamage_W. image == None:
            self.image = load_image('resource/skill/stem_chain.png')
    ...
    def draw(self):
        self.image.clip_draw(0, self.frame * 50, 42, 50, self.x, self.y)